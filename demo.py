...
# 设置草稿文件夹
# draft_folder = draft.DraftFolder(r"C:\Users\YourUser\AppData\Local\JianyingPro\User Data\Projects\com.lveditor.draft") # 默认示例路径
# 这里可以根据本地实际情况修改路径
DUMP_DIR = r"D:\Tool\05_Video\JianyingPro\User Data\Projects\com.lveditor.draft"
draft_folder = draft.DraftFolder(DUMP_DIR)
